    ...
    return (
        <div className="about_page">
            ...
            <div className="about_page-container">
                <img src={mainLogo} alt="Info shape" className="about_page-img animate__animated animate__slow animate__fadeIn animate__delay-5s" />
                <div className="about_page-about">
                    <h3 className=" animate__animated animate__slow animate__fadeInUp animate__delay-2s">I am <span className="co_main">Shady Agamy</span></h3>
                    <p  className=" animate__animated animate__slow animate__fadeInUp animate__delay-3s">I'm a self-taught developer. Four years ago I started front-end web development as a self-study course and learned some new technology skills. I can provide clean code and pixel-perfect design. I also make websites more &#38; more interactive with web animations. I also value lifelong learning and continue to learn from eBooks and video courses from top teaching resources.</p>
                    ...
                    <a className="custom_btn animate__animated animate__slow animate__fadeInUp animate__delay-5s" href="Shadi_Agamy_-_Front_end_Developer.pdf" target="_blank" download>Download cv</a>
                </div>
